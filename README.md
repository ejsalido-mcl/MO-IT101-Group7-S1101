...
| Name | Contribution |
|-------------|--------------|
| Noble, T.H        | Project planning, Assist Display formatting, Testing |
| Salido,E.J        | Attendance data loading, hours calculation logic, grace period implementation, employee data loading implementation, Payroll calculation methods, CSV parsing, Data validation |
| Guillo, S         | Calculation method of SSS, PhilHealth, Pag-IBIG & Tax, assist Display formatting |
| Pancito, N.       | Assist display formatting, Assist Project planning, Testing |
| Espelita, R.      |  Documentation (comments and Readme File) |
...
https://docs.google.com/document/d/1uiBjZwvHzfN-T2628-bRxrHbGDPV07cJs8IZNjQ-Hfw/edit?usp=sharing
